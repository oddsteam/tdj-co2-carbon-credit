...
export default function Section46() {
    return (
        <section className="bg-[#011F1F] w-full h-[200vx] text-white flex justify-center items-center snap-start">
            <div className="bg-[#344243] text-black rounded-[20px] w-[90%] h-[1048px] flex">
                ...
                <div className="w-[73%] p-6 text-white px-15">
                    <p className={`${ibm.className} font-normal text-[16px] leading-[29px] mt-5`}>เปิดข้อมูลคาร์บอนเครดิตป่าไม้ อบก.  ราคาพุ่ง</p>
                    <h2 className={`${chonburi.className} font-normal text-[42px] leading-[100%] mt-5`}>แรงแตะ 3,000 บาทต่อหน่วย</h2>
                    <p className={`${ibm.className} font-normal text-[20px] leading-[38px] mt-10 indent-8`}>
                        ฐานข้อมูลล่าสุดของ อบก. พบว่า มีโครงการที่ได้รับการขึ้นทะเบียนรับรองทั้งหมด 500 โครงการ โดยในจำนวนนี้เป็นโครงการในภาคป่าไม้เพียง 110 โครงการ หรือคิดเป็น สัดส่วนเพียง 22% ของทั้งหมด แม้จะมีจำนวนน้อยแต่โครงการประเภทนี้กลับถูกจัดอยู่ในกลุ่ม
                        ที่มีราคาสูงที่สุด เมื่อเทียบกับคาร์บอนเครดิตจากกิจกรรมประเภทอื่น
                    </p>
                    <p className={`${ibm.className} font-normal text-[20px] leading-[38px] mt-10 indent-8`}>
