            ...
            <div className="bg-[#344243] text-black rounded-[20px] w-[90%] flex">
                ...
                <div className="w-[73%] p-6 text-white px-15">
                    ...
                    <p className={`${ibm.className} font-normal text-[16px] leading-[38px] mt-10 indent-8`}>
                        ...
                        <span className="font-bold text-[#3ED304]"> รับการขึ้นทะเบียนรับรองทั้งหมด 500 โครงการ โดยในจำนวนนี้เป็นโครงการในภาคป่าไม้เพียง 110 โครงการ หรือคิดเป็น สัดส่วนเพียง 22% ของทั้งหมด </span>
