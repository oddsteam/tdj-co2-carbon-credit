                    ...
                    >
                        ...
                        <div className="rounded-[20px] p-6 md:p-10 text-white bg-[#344243] backdrop-blur-[62px] max-h-[60vh] overflow-y-auto">
                            ...
                            <p className={`${ibm.className} text-[20px] font-normal leading-[38px] indent-8`}>
                                สนธิ คชรัตน์ ผู้ทรงคุณวุฒิด้านสิ่งแวดล้อมและสุขภาพ จากชมรมนักวิชาการด้านสิ่งแวดล้อมไทย ระบุว่า ประเทศไทยตั้งเป้าไว้สูงถึง 120 ล้านตัน CO₂ ต่อปี ที่จะต้องดูดซับจากภาคป่าไม้เพื่อให้บรรลุ Carbon Neutrality
                            </p>
                            <br />
                            <p className={`${ibm.className} text-[20px] font-normal leading-[38px] indent-8`}>
                                แต่จากข้อมูลล่าสุด กลับพบว่าป่าไม้ไทยสามารถดูดซับ CO₂ ได้จริงเพียง 29 ล้านตันต่อปี เท่านั้น ช่องว่างกว่า 90 ล้านตันนี้ ไม่ได้สะท้อนแค่ความท้าทายของระบบการดูดซับคาร์บอนจากธรรมชาติ แต่กำลังชี้ให้เห็นว่า เป้าหมายของประเทศอาจกลายเป็น “ภาพฝัน”
                            </p>
                            <br />
                            <p className={`${ibm.className} text-[20px] font-normal leading-[38px] indent-8`}>
                                หากยังคงยึดติดกับกลไกชดเชย (offsetting) ผ่านการปลูกป่า มากกว่าการลดการปล่อยจากต้นทาง (source reduction) อย่างแท้จริงในทางปฏิบัติ ขณะที่โรงงานและภาคธุรกิจยังคงปล่อยก๊าซเรือนกระจกจากปล่องควันในระดับเดิม กลับเลือกใช้การ ซื้อเครดิตจากโครงการปลูกป่า มา “ชดเชย” การปล่อย โดยไม่มีการลดการปล่อยจริงแต่อย่างใด
                            </p>
                            <br />
                            <p className={`${ibm.className} text-[20px] font-normal leading-[38px] indent-8`}>
                                ยิ่งไปกว่านั้น ตัวเลขอัตราการดูดซับคาร์บอน เช่น 6.09 ตันต่อไร่ ที่ใช้ในการคำนวณเครดิต ยังขาดการตรวจสอบอิสระ และไม่มีงานวิจัยรองรับอย่างชัดเจน
                                กรณีนี้จึงตั้งคำถามถึง “ความน่าเชื่อถือของมาตรฐาน” ในตลาดคาร์บอนไทย และชี้ว่าระบบยังเปิดช่องให้มีการ ฟอกเขียว (Greenwashing) ผ่านโครงการปลูกป่า โดยเฉพาะเมื่อกลไกคาร์บอนเครดิตถูกใช้เป็นเครื่องมือเพื่อ “การค้า” มากกว่าการลดคาร์บอนอย่างจริงจัง“ภาพรวมเหมือนปล่อยลด แต่ปล่องควันยังทำงาน”
                            </p>
                            <br />
                            <p className={`${ibm.className} text-[20px] font-normal leading-[38px] indent-8`}>
                                นายสนธิกล่าว พร้อมชี้ว่า การซื้อเครดิตป่าไม้เพื่อแลกกับสิทธิในการส่งออกไปยังยุโรปตามมาตรการ CBAM (Carbon Border Adjustment Mechanism) เป็นเพียงการปรับตัวเพื่อเลี่ยงภาษี ไม่ใช่ความตั้งใจในการลดคาร์บอนจากต้นทาง คำถามจึงไม่ได้อยู่ที่ว่าเราปลูกต้นไม้พอหรือไม่ แต่อยู่ที่ว่าเรากำลังใช้ต้นไม้บังปล่องควันหรือเปล่า? ประเทศไทยอาจต้องทบทวนแนวทางทั้งระบบ หากต้องการไปให้ถึงเป้าหมาย Carbon Neutrality อย่างแท้จริง ไม่ใช่แค่ตัวเลขบนกระดาษ
                            </p>
                            <br />
                            <p className={`${ibm.className} text-[20px] font-bold leading-[38px] indent-8 text-bold`}>
