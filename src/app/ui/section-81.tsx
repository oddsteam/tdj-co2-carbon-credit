        ...
        <section className="w-full h-screen  bg-[#011F1F] flex items-center justify-center text-white px-6 snap-start">
            <div className="max-w-[960px] text-left space-y-6">
                ...
                <p
                    ...
                    style={{ fontFamily: '"IBM Plex Sans Thai Looped", sans-serif' }}
                >
                    โดยมีการติดต่อขอข้อมูลโดยตรงไปยังผู้บริหาร  4 บริษัท ได้แก่  บริษัท ปตท. จำกัด (มหาชน)  2. บริษัท ซีพี ออลล์ จำกัด (มหาชน) 3. บริษัท พฤกษา โฮลดิ้ง จำกัด (มหาชน) และ 4. บริษัท สหพัฒนพิบูล จำกัด (มหาชน) เบื้องต้นมี 2 บริษัทให้ข้อมูลและความคืบหน้าในการจัดการก๊าซเรือนกระจก ดังนี้
                </p>
                <p
                    className="text-[18px] leading-[45px] indent-8"
                    style={{ fontFamily: '"IBM Plex Sans Thai Looped", sans-serif' }}
                >บริษัท ซีพี ออลล์ จำกัด (มหาชน)
                    ...
                    ณัฐพรรษ ตันบุญเอก ประธานเจ้าหน้าที่การเงิน กล่าวถึงการปล่อยก๊าซในปี 2567 และ 2568 ของบริษัทอยู่ที่ 18,610 และ 21,856 ตัน CO₂e โดยได้บรรลุ Carbon Neutrality สำหรับ Scope 1 และ 2 ตั้งแต่ปี 2564 และอยู่ระหว่างบริหารจัดการ Scope 3 เพื่อมุ่งสู่เป้าหมาย Net Zero ในปี 2583-2593
                </p>
