          ...
          <div className="w-full md:w-1/2 mt-16">
            ...
            <div className="max-w-[437px]  w-full">
              <p className={`${ibm.className} text-[16px] leading-[32px] font-normal`}>
                ...
                ขึ้นอยู่กับชนิดพันธุ์ พื้นที่ปลูก และการดูแล เป็น 1 ใน 7 วิธีการลดก๊าซเรือนกระจกตามแนวทางของโครงการ T-VER โดย องค์การบริหารจัดการก๊าซเรือนกระจก (องค์การมหาชน)
