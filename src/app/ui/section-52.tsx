                ...
                <div className="w-1/2 p-6 text-left">
                    <div className="w-[463px]">
                        ...
                        >
                            ...
                            2556-2557 รวมเนื้อที่ทั้งหมด 55,641 ไร่
                        </p>
                        <br></br>
                        <p
                            className="text-[16px] leading-[32px] indent-8"
                            style={{ fontFamily: '"IBM Plex Sans Thai Looped", sans-serif' }}
                        >
                            ซึ่งกลายเป็นประเด็น ที่ถูกจับตามองว่าระบบคาร์บอนเครดิตกำลังเปิดช่องให้กลุ่ม บริษัทและนายทุนใหญ่ใช้กลไกพิเศษบางอย่างเพื่อเข้าถึงสิทธิ การใช้ พื้นที่ป่า ซึ่งโดยหลักการแล้วควรอยู่ภายใต้ระบบการ
