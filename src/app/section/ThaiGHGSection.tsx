    ...
    <section className="bg-[linear-gradient(180deg,_#1C1B18_0%,_#393938_100%)] py-16 px-6 text-white">
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        <div className="w-full max-w-2xl text-left">
          <p className="font-ibm-looped text-[16px] leading-[29px]">
            ข้อมูล
          </p>
        ...
        {/* Chart container */}
        <div className="bg-white w-full max-w-2xl p-4 text-black shadow mt-6">
        ...
        <div className="flex justify-center gap-3 mt-6">
          {["total", "bySector", "delta"].map((key) => (
            <button
              key={key}
              className={`[width:99px] [height:17px] [border-radius:106px] [opacity:1] [transform:rotate(0deg)] transition-all ease-in-out cursor-pointer ${activeTab === key ? "bg-[#E3E3E3]" : "bg-[#72A6AB]"
                }`}
